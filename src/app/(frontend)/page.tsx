...
export const metadata: Metadata = {
  ...
  description: 'Welcome to our educational e-commerce demo showcasing advanced data access patterns in Payload CMS.',
}
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="space-y-4">
        ...
        <div className="text-sm text-gray-500">
          <p>This demo shows the progression from scattered Payload queries to clean abstractions.</p>
